...
extension SearchFileRequest: @unchecked Sendable {}
extension SearchFileResponse: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

extension SearchFileRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "SearchFileRequest"
  ...
  static func ==(lhs: SearchFileRequest, rhs: SearchFileRequest) -> Bool {
...
extension SearchFileResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "SearchFileResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "nodeList"),
  ...
  static func ==(lhs: SearchFileResponse, rhs: SearchFileResponse) -> Bool {
